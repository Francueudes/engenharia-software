...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public void logar() {
        ...
        try {
            ...
            // que doi digitado nas caixas de texto. O ? é suvstituido pelo
            // conteudo das variaveis
            pst = conexao.prepareCall(sql);
            pst.setString(1, txtUsuario.getText());
            pst.setString(2, txtSenha.getText());
            // a linha abaixo executta a query (consulta ao banco de dados)
            rs = pst.executeQuery();
            ...
            if (rs.next()) {
                ...
                // a estrutura abixo faz o tratamento do perfil do usuario
                if (perfil.equals("admin")) {
                    TelaPrincipal principal = new TelaPrincipal();
                    principal.setVisible(true);
                    TelaPrincipal.mUsuarios.setEnabled(true);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(409, 256));
